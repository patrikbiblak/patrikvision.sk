const skTranslations = {
  ...
  "about": {
    ...
    "intro2": "Vytváram rýchle a responzívne webové stránky presne podľa vašich predstáv, ktoré plynule fungujú na rôznych zariadeniach. Môžete sa na mňa spoľahnúť, že vaše nápady premením na pútavú online prezentáciu, ktorá osloví vašich návštevníkov.",
  ...
  "contact": {
    ...
    "message": "Správa",
    "selectProduct": "Vyberte Produkt/Službu",
    "selectCountry": "Vyberte Krajinu/Región",
  ...
  "privacy": {
    ...
    "interactionData": "Interakčné údaje – anonymné štatistiky, údaje o používaní webu.",
    ...
    "emailJS": "EmailJS: do vymazania používateľom alebo 3 roky",
    "contactForms": "Údaje z kontaktných formulárov (cez EmailJS): do vymazania používateľom alebo 3 roky",
