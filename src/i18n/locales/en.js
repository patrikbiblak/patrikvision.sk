const en = {
  ...
  "privacy": {
    ...
    "interactionData": "Interaction data – anonymous statistics, website usage data.",
    ...
    "emailJS": "EmailJS: until deleted by user or 3 years",
    "contactForms": "Contact form data (via EmailJS): until deleted by user or 3 years",
